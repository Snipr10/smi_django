...
SEARCH_PAGE_URL = "https://www.gov.spb.ru/press/announces/?page=%s"
PAGE_URL = "https://www.gov.spb.ru"


def parsing_gov_announces(limit_date, proxy):
    articles = []
    page = 1
    i = 0
    is_ok = True
    ...
    try:
        ...
        if res.ok:
            ...
            try:
                ...
                pass
            article_date = dateparser.parse(soup_all.find("li", {"class": "object-info__item"}).find("p").text.split("—")[0].strip())
